...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="card mb-4">
            <div class="card-body">
                <form action="{{ route('job.store') }}" method="post" id="create_form">
                    @csrf
                    <div class="row">
                        <div class="col-lg-2">
                        ...
                        <div class="col-lg-10">
                            <div class="form-group">
                                <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" placeholder="Nama pekerjaan" value="{{ old('name') }}" required>
                                @error('name')
