...
<section class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-9">
                <h1 class="h3 mb-4 text-gray-800">Kelola Pekerjaan</h1>
            </div>
            <div class="col-lg-3">
                <small>
                    <ol class="breadcrumb">
                        <li><a href="{{ route('dashboard') }}" class="text-decoration-none text-gray-800 mr-2"><i class="icon-dashboard"></i> Home</a></li>
                        <li class="active"><i class="ion-ios-arrow-forward mr-2"></i>Pekerjaan</li>
                    </ol>
                </small>
            </div>
        </div>
        <div class="row">
            <div class="col-lg">
                <div class="d-flex flex-column flex-md-row">
                    <a href="{{ route('job.create') }}" class="btn btn-primary mb-3 mr-1"><span class="fa fa-plus mr-2"></span>Tambah Pekerjaan Baru</a>
                </div>
                @if (count($errors) > 0)
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-secondary">Data Pekerjaan</h6>
                        <div class="dropdown no-arrow">
                            <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <i class="fas fa-ellipsis-v fa-sm fa-fw text-gray-400"></i>
                            </a>
                            <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink" style="">
                                <a class="dropdown-item tombol-bulk-konfirmasi-custom" href="{{ route('job.bulkdestroy') }}" data-message="Pekerjaan yang dipilih ini akan dihapus" data-id-form="bulk-job-form">Hapus <span class="text-info">pekerjaan</span> yang dipilih</a>
                            </div>
                        </div>
                    </div>
                    <form id="bulk-job-form" action="" method="POST">
                        @csrf
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-hover" id="jobdata">
                                    <thead>
                                        <tr>
                                            <th>
        ...
        <form method="post" action="" enctype="multipart/form-data">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="importExcelLabel">Import Excel for Pekerjaan</h5>
...
<script>
    ...
    function fillDataTable() {
        $('#jobdata').DataTable().destroy();
        let s_name = $('#s_name').val();

        //datatables
        const table = $('#jobdata').DataTable({
