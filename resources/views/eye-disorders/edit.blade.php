...
@section('title', 'Edit Data Keluhan di Mata')
...
<li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="{{ route('eye-disorder') }}">Data Keluhan di Mata</a></li>
...
<section class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-9">
                <h1 class="h3 mb-4 text-gray-800">Edit Data Keluhan di Mata</h1>
            </div>
            <div class="col-lg-3">
                <small>
                    <ol class="breadcrumb">
                        <li><a href="{{ route('dashboard') }}" class="text-decoration-none text-gray-800 mr-2"><i class="icon-dashboard"></i> Home</a></li>
                        <li><a href="{{ route('eye-disorder') }}" class="text-decoration-none text-gray-800 mr-2"><i class="ion-ios-arrow-forward mr-2"></i>Data Keluhan di Mata</a></li>
        ...
        <div class="card mb-4">
            <div class="card-body">
                <form action="{{ route('eye-disorder.update',$eyeDisorder->id) }}" method="post" id="edit_form">
                    @method('patch')
                    @csrf
                    <div class="row">
                        <div class="col-lg-2">
                        ...
                        <div class="col-lg-10">
                            <div class="form-group">
                                <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" placeholder="Keluhan di mata" value="{{ old('name',$eyeDisorder->name) }}" required>
                                @error('name')
