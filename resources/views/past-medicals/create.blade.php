...
@section('title', 'Tambah Riwayat Penyakit')
...
<section class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-9">
                <h1 class="h3 mb-4 text-gray-800">Tambah Riwayat Penyakit</h1>
            </div>
            <div class="col-lg-3">
                <small>
                    <ol class="breadcrumb">
        ...
        <div class="card mb-4">
            <div class="card-body">
                <form action="{{ route('past-medical.store') }}" method="post" id="create_form">
                    @csrf
                    <div class="row">
                        <div class="col-lg-2">
                        ...
                        <div class="col-lg-10">
                            <div class="form-group">
                                <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" placeholder="Nama penyakit" value="{{ old('name') }}" required>
                                @error('name')
