            ...
            <div class="col-lg-3">
                <small>
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><i class="ion-ios-arrow-forward mr-2"></i>User</li>
                    </ol>
                </small>
            </div>
        </div>
        <div class="row">
            <div class="col-lg">
                <div class="d-flex flex-column flex-md-row">
                    <a href="{{ route('user.create') }}" class="btn btn-primary mb-3 mr-1"><span class="fa fa-plus mr-2"></span>Tambah User Baru</a>
                </div>
                @if (count($errors) > 0)
                ...
                <div class="card shadow mb-4">
                    ...
                    <form id="bulk-user-form" action="" method="POST">
                        @csrf
                        <div class="card-body">
        ...
        <form method="post" action="" enctype="multipart/form-data">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="importExcelLabel">Import Excel for User</h5>
...
@push('scripts')
<script>
    getDataSelect2Search('s_roles', '{{ route("getroles") }}', '- Cari role user -', 0, true, {}, true)
    fillDataTable();
    ...
    function fillDataTable() {
        ...
        //datatables
        const table = $('#userdata').DataTable({
